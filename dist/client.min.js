...
`;
    ...
    let canRegister = observers_1.computed((username, password, repeat_password, display_name) => {
        if (username === "") {
            return false;
        }
        if (password === "") {
    ...
    function navigate(uri, use_cache = false) {
        ...
        if (is.absent(verifiedToken.getState())) {
            ...
            mount.appendChild(xml.element("div.content.content--narrow")
                ...
                .add(renderTextParagraph(xml.text("Please login using your credentials or register a new user with the credentials desired. Registration keys can when requested be obtained from the circus manager and are consumed upon successful registration."))))
                .add(xml.element("button")
