...
define("build/api/schema/objects", ["require", "exports", "build/database/schema", "build/database/schema", "build/database/schema", "build/database/schema", "node_modules/@joelek/ts-autoguard/build/autoguard-lib/index"], function (require, exports, schema_1, schema_2, schema_3, schema_4, ts_autoguard_2) {
    ...
    exports.PersonBase = ts_autoguard_2.guards.Object.of({
        "person_id": ts_autoguard_2.guards.String,
        "name": ts_autoguard_2.guards.String
    });
    exports.Person = ts_autoguard_2.guards.Intersection.of(ts_autoguard_2.guards.Reference.of(() => exports.PersonBase), ts_autoguard_2.guards.Object.of({}));
    ...
    exports.Movie = ts_autoguard_2.guards.Intersection.of(ts_autoguard_2.guards.Reference.of(() => exports.MovieBase), ts_autoguard_2.guards.Object.of({
        ...
        "actors": ts_autoguard_2.guards.Array.of(ts_autoguard_2.guards.Reference.of(() => exports.Person)),
        "last_stream_date": ts_autoguard_2.guards.Union.of(ts_autoguard_2.guards.Undefined, ts_autoguard_2.guards.Number),
    ...
    exports.EntityBase = ts_autoguard_2.guards.Union.of(ts_autoguard_2.guards.Reference.of(() => exports.AlbumBase), ts_autoguard_2.guards.Reference.of(() => exports.ArtistBase), ts_autoguard_2.guards.Reference.of(() => exports.CueBase), ts_autoguard_2.guards.Reference.of(() => exports.DiscBase), ts_autoguard_2.guards.Reference.of(() => exports.EpisodeBase), ts_autoguard_2.guards.Reference.of(() => exports.GenreBase), ts_autoguard_2.guards.Reference.of(() => exports.MovieBase), ts_autoguard_2.guards.Reference.of(() => exports.PersonBase), ts_autoguard_2.guards.Reference.of(() => exports.PlaylistBase), ts_autoguard_2.guards.Reference.of(() => exports.SeasonBase), ts_autoguard_2.guards.Reference.of(() => exports.ShowBase), ts_autoguard_2.guards.Reference.of(() => exports.TrackBase), ts_autoguard_2.guards.Reference.of(() => exports.UserBase), ts_autoguard_2.guards.Reference.of(() => exports.YearBase));
    exports.Entity = ts_autoguard_2.guards.Union.of(ts_autoguard_2.guards.Reference.of(() => exports.Album), ts_autoguard_2.guards.Reference.of(() => exports.Artist), ts_autoguard_2.guards.Reference.of(() => exports.Cue), ts_autoguard_2.guards.Reference.of(() => exports.Disc), ts_autoguard_2.guards.Reference.of(() => exports.Episode), ts_autoguard_2.guards.Reference.of(() => exports.Genre), ts_autoguard_2.guards.Reference.of(() => exports.Movie), ts_autoguard_2.guards.Reference.of(() => exports.Person), ts_autoguard_2.guards.Reference.of(() => exports.Playlist), ts_autoguard_2.guards.Reference.of(() => exports.Season), ts_autoguard_2.guards.Reference.of(() => exports.Show), ts_autoguard_2.guards.Reference.of(() => exports.Track), ts_autoguard_2.guards.Reference.of(() => exports.User), ts_autoguard_2.guards.Reference.of(() => exports.Year));
    exports.Autoguard = {
    ...
    class IconFactory {
        ...
        makeNext() {
            return xnode.element("svg")
                ...
                .set("viewBox", "0 0 16 16")
                .add(xnode.element("path")
                .set("d", "M1,15.268c-0.173,0-0.345-0.045-0.5-0.134C0.19,14.955,0,14.625,0,14.268V1.732c0-0.357,0.19-0.688,0.5-0.866C0.655,0.776,0.827,0.732,1,0.732s0.345,0.044,0.5,0.134l10.855,6.269c0.31,0.179,0.5,0.509,0.5,0.866s-0.19,0.688-0.5,0.866L1.5,15.134C1.345,15.223,1.173,15.268,1,15.268z")).add(xnode.element("path")
...
`;
    ...
    */
    ...
    let updateviewforuri = (uri) => {
        ...
        if (false) {
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/audio/tracks/${encodeURIComponent(query)}?offset=${offset}&token=${token}`, {});
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/video/seasons/${encodeURIComponent(query)}?offset=${offset}&token=${token}`, {});
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/audio/discs/${encodeURIComponent(query)}?offset=${offset}&token=${token}`, {});
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/users/${encodeURIComponent(query)}?offset=${offset}&token=${token}`, {});
            ...
            req(`/api/persons/${person_id}/?token=${token}`, {}, (_, response) => {
                let person = response.person;
                req(`/api/persons/${person_id}/shows/?token=${token}`, {}, (_, response) => {
                    let shows = response.shows;
                    req(`/api/persons/${person_id}/movies/?token=${token}`, {}, (_, response) => {
            ...
            let reachedEnd = new observers_2.ObservableClass(false);
            let isLoading = new observers_2.ObservableClass(false);
            let persons = new observers_2.ArrayObservable([]);
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/persons/${encodeURIComponent(query)}?offset=${offset}&token=${token}`, {});
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/audio/albums/?offset=${offset}&token=${token}`, {});
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/audio/artists/?offset=${offset}&token=${token}`, {});
            ...
            req(`/api/audio/playlists/?token=${token}`, {}, (status, response) => {
                let playlists = response.playlists;
                mount.appendChild(xml.element("div")
                    .add(xml.element("div.content")
            ...
            req(`/api/video/shows/?token=${token}`, {}, (status, response) => {
                let shows = response.shows;
                mount.appendChild(xml.element("div")
                    .add(xml.element("div.content")
                    .add(renderTextHeader(xml.text("Shows"))))
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/video/episodes/${encodeURIComponent(query)}?offset=${offset}&token=${token}`, {});
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/video/movies/?offset=${offset}&token=${token}`, {});
                    for (let movie of response.movies) {
                        movies.append(movie);
                    }
                    offset += response.movies.length;
            ...
            async function load() {
                if (!reachedEnd.getState() && !isLoading.getState()) {
                    isLoading.updateState(true);
                    let response = await preq(`/api/video/cues/${encodeURIComponent(query.getState())}?offset=${offset}&token=${token}`, {});
            ...
            req(`/api/video/genres/?token=${token}`, {}, (status, response) => {
            ...
            preq(`/api/years/${encodeURIComponent(query)}?length=100&token=${token}`, {}).then((response) => {
    ...
    let mounted_uri;
    function navigate(uri, restore_scroll = false) {
