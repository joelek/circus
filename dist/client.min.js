...
define("build/api/schema/api/index", ["require", "exports", "node_modules/@joelek/ts-autoguard/dist/lib-shared/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/messages/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/messages/index", "build/api/schema/messages/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/objects/index", "build/api/schema/objects/index"], function (require, exports, autoguard, objects_1, objects_2, objects_3, objects_4, objects_5, objects_6, messages_1, objects_7, objects_8, objects_9, messages_2, messages_3, objects_10, objects_11, objects_12, objects_13, objects_14) {
    ...
    exports.ArtistResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_3.Artist),
        "rank": autoguard.guards.Number
    }, {});
    exports.DiscResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_4.Disc),
        "rank": autoguard.guards.Number
    }, {});
    exports.EpisodeResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_6.Episode),
        "rank": autoguard.guards.Number
    }, {});
    exports.GenreResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_7.Genre),
        "rank": autoguard.guards.Number
    }, {});
    exports.MovieResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_8.Movie),
        "rank": autoguard.guards.Number
    }, {});
    exports.PlaylistResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_9.Playlist),
        "rank": autoguard.guards.Number
    }, {});
    exports.SeasonResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_10.Season),
        "rank": autoguard.guards.Number
    }, {});
    exports.ShowResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_11.Show),
        "rank": autoguard.guards.Number
    }, {});
    exports.TrackResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_12.Track),
        "rank": autoguard.guards.Number
    }, {});
    exports.UserResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_13.User),
        "rank": autoguard.guards.Number
    }, {});
    exports.YearResult = autoguard.guards.Object.of({
        "entity": autoguard.guards.Reference.of(() => objects_14.Year),
        "rank": autoguard.guards.Number
    }, {});
    var Autoguard;
    (function (Autoguard) {
