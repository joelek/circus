...
define("build/database/indexer", ["require", "exports", "crypto", "fs", "build/database/schema", "build/jsondb/index", "build/is", "build/database/probes/index", "build/config/index", "build/jdb/index"], function (require, exports, libcrypto, libfs, schema, indices, is, probes, config_1, jdb) {
    ...
    exports.actors = loadIndex("actors", schema.Actor, (record) => record.actor_id);
    exports.movie_actors = loadIndex("movie_actors", schema.MovieActor, (record) => makeId(record.movie_id, record.actor_id));
    exports.getMoviesFromActor = indices.CollectionIndex.fromTable(exports.actors, exports.movie_actors, (record) => record.actor_id);
    exports.getActorsFromMovie = indices.CollectionIndex.fromTable(exports.movies, exports.movie_actors, (record) => record.movie_id);
    exports.show_actors = loadIndex("show_actors", schema.ShowActor, (record) => makeId(record.show_id, record.actor_id));
    exports.getShowsFromActor = indices.CollectionIndex.fromTable(exports.actors, exports.show_actors, (record) => record.actor_id);
    exports.getActorsFromShow = indices.CollectionIndex.fromTable(exports.shows, exports.show_actors, (record) => record.show_id);
    ...
    exports.actor_search = indices.SearchIndex.fromTable(exports.actors, (entry) => [entry.name]);
...
define("build/api/handler", ["require", "exports", "crypto", "build/server/auth", "build/server/passwords", "build/database/indexer", "build/jsondb/index", "build/is", "build/config/index"], function (require, exports, libcrypto, auth, passwords, database, jsondb, is, config_2) {
    ...
    function lookupActorBase(actor_id, user_id) {
        ...
        return {
            ...
            name: config_2.default.use_demo_mode ? "Actor name" : actor.name
        };
    }
...
define("build/api/schema/objects", ["require", "exports", "build/database/schema", "build/database/schema", "build/database/schema", "build/database/schema", "node_modules/@joelek/ts-autoguard/build/autoguard-lib/index"], function (require, exports, schema_1, schema_2, schema_3, schema_4, ts_autoguard_5) {
    ...
    exports.ActorBase = ts_autoguard_5.guards.Object.of({
        "actor_id": ts_autoguard_5.guards.String,
        "name": ts_autoguard_5.guards.String
    });
    exports.Actor = ts_autoguard_5.guards.Intersection.of(ts_autoguard_5.guards.Reference.of(() => exports.ActorBase), ts_autoguard_5.guards.Object.of({}));
    ...
    exports.Movie = ts_autoguard_5.guards.Intersection.of(ts_autoguard_5.guards.Reference.of(() => exports.MovieBase), ts_autoguard_5.guards.Object.of({
        ...
        "actors": ts_autoguard_5.guards.Array.of(ts_autoguard_5.guards.Reference.of(() => exports.Actor)),
        "last_stream_date": ts_autoguard_5.guards.Union.of(ts_autoguard_5.guards.Undefined, ts_autoguard_5.guards.Number),
    ...
    exports.EntityBase = ts_autoguard_5.guards.Union.of(ts_autoguard_5.guards.Reference.of(() => exports.ActorBase), ts_autoguard_5.guards.Reference.of(() => exports.AlbumBase), ts_autoguard_5.guards.Reference.of(() => exports.ArtistBase), ts_autoguard_5.guards.Reference.of(() => exports.CueBase), ts_autoguard_5.guards.Reference.of(() => exports.DiscBase), ts_autoguard_5.guards.Reference.of(() => exports.EpisodeBase), ts_autoguard_5.guards.Reference.of(() => exports.GenreBase), ts_autoguard_5.guards.Reference.of(() => exports.MovieBase), ts_autoguard_5.guards.Reference.of(() => exports.PlaylistBase), ts_autoguard_5.guards.Reference.of(() => exports.SeasonBase), ts_autoguard_5.guards.Reference.of(() => exports.ShowBase), ts_autoguard_5.guards.Reference.of(() => exports.TrackBase), ts_autoguard_5.guards.Reference.of(() => exports.UserBase), ts_autoguard_5.guards.Reference.of(() => exports.YearBase));
    exports.Entity = ts_autoguard_5.guards.Union.of(ts_autoguard_5.guards.Reference.of(() => exports.Actor), ts_autoguard_5.guards.Reference.of(() => exports.Album), ts_autoguard_5.guards.Reference.of(() => exports.Artist), ts_autoguard_5.guards.Reference.of(() => exports.Cue), ts_autoguard_5.guards.Reference.of(() => exports.Disc), ts_autoguard_5.guards.Reference.of(() => exports.Episode), ts_autoguard_5.guards.Reference.of(() => exports.Genre), ts_autoguard_5.guards.Reference.of(() => exports.Movie), ts_autoguard_5.guards.Reference.of(() => exports.Playlist), ts_autoguard_5.guards.Reference.of(() => exports.Season), ts_autoguard_5.guards.Reference.of(() => exports.Show), ts_autoguard_5.guards.Reference.of(() => exports.Track), ts_autoguard_5.guards.Reference.of(() => exports.User), ts_autoguard_5.guards.Reference.of(() => exports.Year));
    exports.Autoguard = {
