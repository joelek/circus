...
define("build/jdb/index", ["require", "exports", "crypto", "fs", "node_modules/@joelek/ts-autoguard/build/autoguard-lib/index", "node_modules/@joelek/ts-stdlib/build/index", "build/is", "build/jsondb/index"], function (require, exports, libcrypto, libfs, autoguard, stdlib, is, jsondb_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Index = exports.IndexRecord = exports.IndexEntry = exports.IndexHeader = exports.Table = exports.RecordIndexEntry = exports.RecordIndexHeader = exports.computeHash = void 0;
...
define("build/database/indexer", ["require", "exports", "crypto", "fs", "build/database/schema", "build/jsondb/index", "build/is", "build/database/probes/index", "build/config/index", "build/jdb/index"], function (require, exports, libcrypto, libfs, schema, indices, is, probes, config_1, jdb) {
    ...
    function loadIndex(name, parent, child, getGroupKey, tokenizer = jdb.Index.VALUE_TOKENIZER, maxGroupSize) {
        let index = new jdb.Index(INDICES_ROOT, name, (key) => child.lookup(key), getGroupKey, (record) => child.keyof(record), tokenizer, maxGroupSize);
        if (index.length() === 0) {
    ...
    exports.album_search = loadIndex("search_albums", exports.albums, exports.albums, (entry) => [entry.title, entry.year].filter(is.present), jdb.Index.QUERY_TOKENIZER);
    exports.artist_search = loadIndex("search_artists", exports.artists, exports.artists, (entry) => [entry.name], jdb.Index.QUERY_TOKENIZER);
    ...
    exports.episode_search = loadIndex("search_episodes", exports.episodes, exports.episodes, (entry) => [entry.title, entry.year].filter(is.present), jdb.Index.QUERY_TOKENIZER);
    exports.genre_search = loadIndex("search_genres", exports.genres, exports.genres, (entry) => [entry.name], jdb.Index.QUERY_TOKENIZER);
    exports.movie_search = loadIndex("search_movies", exports.movies, exports.movies, (entry) => [entry.title, entry.year].filter(is.present), jdb.Index.QUERY_TOKENIZER);
    exports.actor_search = loadIndex("search_actors", exports.actors, exports.actors, (entry) => [entry.name], jdb.Index.QUERY_TOKENIZER);
    exports.playlist_search = loadIndex("search_playlists", exports.playlists, exports.playlists, (entry) => [entry.title], jdb.Index.QUERY_TOKENIZER);
    exports.shows_search = loadIndex("search_shows", exports.shows, exports.shows, (entry) => [entry.name], jdb.Index.QUERY_TOKENIZER);
    exports.track_search = loadIndex("search_tracks", exports.tracks, exports.tracks, (entry) => [entry.title], jdb.Index.QUERY_TOKENIZER);
    exports.user_search = loadIndex("search_users", exports.users, exports.users, (entry) => [entry.name, entry.username], jdb.Index.QUERY_TOKENIZER);
    exports.year_search = loadIndex("search_years", exports.years, exports.years, (entry) => [entry.year], jdb.Index.QUERY_TOKENIZER);
