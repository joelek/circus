...
define("build/config/schema", ["require", "exports", "node_modules/@joelek/ts-autoguard/build/autoguard-lib/index"], function (require, exports, ts_autoguard_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Autoguard = exports.Config = void 0;
    exports.Config = ts_autoguard_3.guards.Object.of({
        "use_cue_index": ts_autoguard_3.guards.Union.of(ts_autoguard_3.guards.Undefined, ts_autoguard_3.guards.Boolean)
    });
    exports.Autoguard = {
        "Config": exports.Config
    };
});
define("build/config/index", ["require", "exports", "fs", "build/config/schema"], function (require, exports, libfs, schema) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const ROOT = [
        ".",
...
define("build/api/handler", ["require", "exports", "crypto", "build/server/auth", "build/server/passwords", "build/database/indexer", "build/jsondb/index", "build/is"], function (require, exports, libcrypto, auth, passwords, database, jsondb, is) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("build/chromecast/chromecasts", ["require", "exports", "tls", "build/chromecast/cast_message", "build/mdns/index", "build/chromecast/schema/index", "build/is", "build/languages", "build/observers/index", "build/player/client", "node_modules/@joelek/ts-autoguard/build/autoguard-lib/index", "node_modules/@joelek/ts-sockets/build/index", "node_modules/@joelek/ts-stdlib/build/index", "build/api/schema/objects"], function (require, exports, libtls, cast_message, mdns, schema, is, languages, observers, libcontext, autoguard, sockets, stdlib, objects_17) {
    ...
    function makeMediaInformation(item, token) {
    ...
    class ChromecastPlayer {
        constructor(socket, wss, device_name, device_type) {
...
define("build/airplay/device", ["require", "exports", "crypto", "node_modules/@joelek/ts-sockets/build/index", "node_modules/@joelek/ts-stdlib/build/index", "build/player/client", "build/is", "build/observers/index", "build/airplay/schema/index", "build/airplay/api", "build/airplay/http", "build/airplay/plist"], function (require, exports, libcrypto, sockets, stdlib, player, is, observers, schema, api, http, plist) {
    ...
    class Device extends stdlib.routing.MessageRouter {
        constructor(host, wss, device_name, device_type) {
            super();
        ...
        mdns.observe("_airplay._tcp.local", async (service_device) => {
            try {
                ...
                if (is.absent(device)) {
                    ...
                    let device = new device_1.Device(hostname, wss, device_name, device_type);
...
define("build/server/server", ["require", "exports", "crypto", "fs", "http", "https", "path", "url", "build/api/api", "build/server/auth", "build/database/indexer", "build/server/subsearch", "build/player/index", "build/playlists/index", "build/chromecast/chromecasts", "build/airplay/index", "build/is"], function (require, exports, libcrypto, libfs, libhttp, libhttps, libpath, liburl, api, auth, indexer, subsearch, context, playlists, chromecasts, airplay, is) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
