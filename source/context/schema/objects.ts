...
import { Album, Artist, Track, Movie, Show, Season, Episode } from "../../media/schema/objects";
...
export type Context = ContextAlbum | ContextArtist | ContextTrack | ContextMovie | ContextShow | ContextSeason | ContextEpisode;
