			...
			let element = xml.element("div")
				.add(xml.element("div.content")
					...
					.add(xml.element("div")
						...
						.add(...album.categories.slice(0, 5).map((category) => EntityRow.forCategory(category)))
					)
			...
			let element = xml.element("div")
				.add(xml.element("div.content")
					...
					.add(xml.element("div")
						...
						.add(...artist.categories.slice(0, 5).map((category) => EntityRow.forCategory(category)))
					)
			...
			let element = xml.element("div")
				.add(xml.element("div.content")
					...
					.add(xml.element("div")
						...
						.set("style", "display: grid; gap: 16px;")
						.add(...actors.slice(0, 5).map((actor) => EntityRow.forActor(actor)))
					)
					.add(xml.element("div")
						.set("style", "display: grid; gap: 24px;")
